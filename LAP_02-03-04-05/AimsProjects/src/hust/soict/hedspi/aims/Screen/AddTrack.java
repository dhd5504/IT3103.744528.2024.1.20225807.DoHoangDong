...
import src.hust.soict.hedspi.aims.Screen.controller.AddTrackScreenController;
...
//20222
    public AddTrack(CompactDisc CD) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("addTrack.fxml"));//hust/soict/cybersec/aims/screen/view/addTracks.fxml
