...
//                                                    "Roger Aller",19.95f);
//                                                          
//        DigitalVideoDisc dvd2 = new DigitalVideoDisc(2,"Star War", "Science Fiction",  
//                                                    "George Lucas",87, 24.95f); 
//        DigitalVideoDisc dvd3 = new DigitalVideoDisc(3,"Aladdin", "Animation", null,  
//                                                    0, 18.99f);
//        store.addMedia(dvd1);
//        store.addMedia(dvd2);
//        store.addMedia(dvd3);
...
//        Book book2 = new Book(3,"On the Origin of Time: Stephen Hawking's Final Theory", 
//                            "Science", 120.00f);
//        store.addMedia(book);
//        store.addMedia(book1);
//        store.addMedia(book2);
//
//        CompactDisc cd1 = new CompactDisc("Adele - 30", "Music","Adele", 150.98f);
...
//    
    ...
    public StoreScreen(Store store) {
        ...
        setTitle("Do Hoang Dong - 20225807 - Store");
		setSize(1024, 768);
		setVisible(true);
